...
###	The exponential law of learning
...
More precisely, RELL makes two assumptions about the underlying process:
1.	a finite set of items
2.	a constant probability to decay, whereby decay means the item is lost forever
